...
namespace Unity.Animation
{
    ...
    public abstract class ProcessAnimationGraphBase
        : ProcessAnimationGraphBase<NotSupportedTransformHandle, NotSupportedTransformHandle, NotSupportedRootMotion>
    {
    }

    public abstract class ProcessAnimationGraphBase<TReadTransformHandle, TWriteTransformHandle>
        : ProcessAnimationGraphBase<TReadTransformHandle, TWriteTransformHandle, NotSupportedRootMotion>
    ...
    /// </summary>
    public abstract partial class ProcessAnimationGraphBase<TReadTransformHandle, TWriteTransformHandle, TAnimatedRootMotion>
        ...
        where TAnimatedRootMotion   : struct, IAnimatedRootMotion
    {
        ...
        protected ProcessAnimationGraphBase()
        {
