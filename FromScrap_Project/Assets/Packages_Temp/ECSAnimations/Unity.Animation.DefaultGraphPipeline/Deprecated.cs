...
namespace Unity.Animation
{
    ...
    public abstract partial class BeginFrameAnimationSystemBase : SystemBase
    {
    }

    [EditorBrowsable(EditorBrowsableState.Never)]
    [Obsolete("Renamed to ComputeDeformationDataBase (RemovedAfter 2020-12-21) (UnityUpgradable) -> ComputeDeformationDataBase", true)]
    public abstract partial class ComputeDeformationDataSystemBase : SystemBase
    {
    }
    ...
    public abstract partial class RigComputeMatricesSystemBase : SystemBase
    {
    }
}
