...
namespace Unity.Physics.Stateful
{
    ...
    public partial class CollisionEventConversionSystem : SystemBase
    {
        ...
        public struct CollectCollisionEventsJob : ICollisionEventsJob
        {
            ...
            {
                var entityA = UpdateEntityWithChilds(collisionEvent.EntityA, collisionEvent.ColliderKeyA.Value);
                var entityB = UpdateEntityWithChilds(collisionEvent.EntityB, collisionEvent.ColliderKeyB.Value);
                
                var collisionEventBufferElement = new StatefulCollisionEvent(entityA, entityB,
